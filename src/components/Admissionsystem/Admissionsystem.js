...
function Admissionsystem(){
    return(
        <div style={{position: "relative"}}>
            <div id="bg1">
                <img src={bg1_img} alt="" className="bgImg"></img>
                <div id="bg1-text">
                    <p>课业成绩比兴趣爱好更重要？</p>
            ...
            <div id="bg3">
                ...
                <div className="bg3-ctx">
                    <div id="bg3-img1">
                        <img src={bg3_img1} alt=""></img>
                    </div>
            ...
            <div id="bg4">
                ...
                <div id="bg4-img">
                    <img src={bg4_img} alt=""></img>
                </div>
                <div className="bg4-ctx">
                    <div className="bg4-ctx-icons">
                        <img id="bg4-icon1" src={bg4_icon} alt="" ></img>
                        <img id="bg4-icon2" src={bg4_icon} alt="" ></img>
                        <img id="bg4-icon3" src={bg4_icon} alt="" ></img>
                        <img id="bg4-icon4" src={bg4_icon} alt="" ></img>
                        <img id="bg4-icon5" src={bg4_icon} alt="" ></img>
                    </div>
                    <div id="bg4-text2">
            ...
            <div id="bg5">
                <img className="bgImg" src={bg5_img} alt=""></img>
                <div>
                    <video id="bg5-video1" src="https://cdn.modao.cc/Default_video.mp4" controls ></video>
                    <video id="bg5-video2" src="https://cdn.modao.cc/Default_video.mp4" controls ></video>
                    <video id="bg5-video3" src="https://cdn.modao.cc/Default_video.mp4" controls ></video>
                    <video id="bg5-video4" src="https://cdn.modao.cc/Default_video.mp4" controls ></video>
                    <video id="bg5-video5" src="https://cdn.modao.cc/Default_video.mp4" controls ></video>
                    <video id="bg5-video6" src="https://cdn.modao.cc/Default_video.mp4" controls ></video>
                </div>
                <div className="bg5-btns">
